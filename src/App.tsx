        ...
        >
          <div className="flex-1">
            <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-white to-zinc-400 text-transparent bg-clip-text">
              Hello, I'm Sriram Pranav
            </h1>
            <p className="text-xl text-zinc-400 max-w-2xl mb-8">
            Computer Science and Engineering student who enjoys solving problems and building useful web applications. I have a strong understanding of Java, Data Structures, and Algorithms, along with hands-on experience in competitive programming and MERN stack development,
            competitive programming, and building efficient, user-friendly web applications. Passionate about learning new technologies and contributing to real-world projects.
                     </p>
            <div className="flex gap-4">
              ...
              <motion.a
                href="https://drive.google.com/file/d/1T6Gb8PRzPvrjOLEZi2Vj62rOkJAs8d9r/view?usp=sharing"
                target="_blank"
